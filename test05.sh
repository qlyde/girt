...
out=$(girt-rm d 2>&1)
test -z "$out" || failed "$0: test 6 failed: got unexpected output '$out'"
test ! -e d || failed "$0: test 6 failed: file d was not deleted"
echo "test 6 passed"
...
test -z "$out" || failed "$0: test 7 failed: got unexpected output '$out'"
test -e e || failed "$0: test 7 failed: file e was deleted with --cached flag"
echo "test 7 passed"
...
test -z "$out" || failed "$0: test 8 failed: got unexpected output '$out'"
test -e f || failed "$0: test 8 failed: file f was deleted with --cached flag"
test "$(cat f)" = "hello world" || failed "$0: test 8 failed: file f has incorrect contents"
...
test -z "$out" || failed "$0: test 9 failed: got unexpected output '$out'"
test -e g || failed "$0: test 9 failed: file g was deleted with --cached flag"
test "$(cat g)" = "hello world" || failed "$0: test 9 failed: file g has incorrect contents"
...
test -z "$out" || failed "$0: test 10 failed: got unexpected output '$out'"
test ! -e h || failed "$0: test 10 failed: file h was not deleted with --force flag"
